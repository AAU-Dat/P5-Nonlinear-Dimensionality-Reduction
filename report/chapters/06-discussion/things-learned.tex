...
%Brainstorm
%We learned how to make a pipeline --> hyperparameter optimization, cross-validation, and evaluation

%We learned how to use Dimensionality reduction --> when does it make sense to reduce, linear vs nonlinear(and their differences), and use cases.

%We have learned about classification

%We have learned the importance data and in regard to its curse of dimensionality

%We have learned how to use tools in order to reduce the dimensions and create a pipeline
