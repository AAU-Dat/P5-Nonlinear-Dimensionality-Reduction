...
\noindent
In this project we will study some common methods of dimensionality reduction. Inspired by the MNIST dataset for digit recognition, we wish to test similar algorithm on pokemon image data.\question{Note: Unique problem in pokemon classification based on colors is the handling of SHINY pokemon. How will we handle this?}
