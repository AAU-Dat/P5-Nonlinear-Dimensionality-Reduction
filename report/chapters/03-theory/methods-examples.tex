...
\begin{figure}
    \centering
    \subfloat[\centering LDA on iris]{\label{fig:iris-lda}{\includegraphics[width=0.4\textwidth]{figures/theory-example-figures/iris-lda.png} }}
    \qquad
    \subfloat[\centering PCA on iris]{\label{fig:iris-pca}{\includegraphics[width=0.4\textwidth]{figures/theory-example-figures/iris-pca.png} }}%
...
\begin{figure}
    \centering
    \subfloat[\centering Isomap on iris]{\label{fig:iris-isomap}{\includegraphics[width=0.4\textwidth]{figures/theory-example-figures/iris-isomap.png} }}
    \qquad
    \subfloat[\centering KernelPCA on iris]{\label{fig:iris-kernelpca}{\includegraphics[width=0.4\textwidth]{figures/theory-example-figures/iris-kernelpca.png} }}
...
\begin{figure}
    \centering
    \subfloat[\centering LDA on circles]{\label{fig:circles-lda}{\includegraphics[width=0.4\textwidth]{figures/theory-example-figures/circles-lda.png} }}
    \qquad
    \subfloat[\centering PCA on circles]{\label{fig:circles-pca}{\includegraphics[width=0.4\textwidth]{figures/theory-example-figures/circles-pca.png} }}
...
\begin{figure}
    \centering
    \subfloat[\centering Isomap on circles]{\label{fig:circles-isomap}{\includegraphics[width=0.4\textwidth]{figures/theory-example-figures/circles-isomap.png} }}
    \qquad
    \subfloat[\centering KernelPCA on circles]{\label{fig:circles-kernelpca}{\includegraphics[width=0.4\textwidth]{figures/theory-example-figures/circles-kernelpca.png} }}
