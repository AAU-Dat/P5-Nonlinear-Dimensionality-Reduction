\newcommand{relu}{ReLU}{Rectified Linear Unit}
...
%why is there are the quora link. We need something better than a mediocre comment - Ray 
...
\subsubection{Convolutional Neural Networks}\label{subsubsec:convolutional-neural-networks}
...
The last layer is the fully-connected layer, which is connected to all the neurons from the pooling layer. According to Keiron ~\cite{introduction-to-cnn}, the activation function \gls{relu} might be suited to be used in this layer too.
