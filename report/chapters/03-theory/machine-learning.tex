...
%why is there are the quora link. We need something better than a reddit comment
...
%Provide theory regarding the models
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{convolutional.png}
\caption{The architecture of a convolutional neural network.}
\label{fig:convolutional}
\end{figure}

The \gls{cnn} is a special type of \gls{nn}
