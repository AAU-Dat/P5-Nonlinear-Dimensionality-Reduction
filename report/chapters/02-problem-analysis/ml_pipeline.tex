...
\begin{tikzpicture}
	...
	\node (e) [state, shift={($(a.south)+(0,-2cm)$)}] {parameters};
    ...
    \draw [arrow, ->] (d.south) -- ++(0,-0.75) -| (clusterA_g.south);
\end{tikzpicture}
\caption{ML pipeline}
