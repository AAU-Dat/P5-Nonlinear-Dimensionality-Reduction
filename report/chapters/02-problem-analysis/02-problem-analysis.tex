...
We have in this chapter presented the pipeline and given an overview of the different components of the pipeline. With this knowledge, we can now move on to the problem statement. \todo[inline]{Add text to describe why linear vs nonlinear would work in this dataset.}