...
\section{Dimensionality reduction}\label{sec:dimensionality-reduction-problem}\todo[inline]{What is dimensionality reduction? What are its advantages? Computation? Interpretability?}
