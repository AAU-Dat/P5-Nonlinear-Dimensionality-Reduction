...
\addbibresource{bib/raymond.bib}
...
% Other potential options for setminted: frame=topline, framesep=6pt, style=colorful, fontsize=\footnotesize, 
\setminted[python]{linenos, breaklines, autogobble} %Change language later
...
\usepackage[acronym, shortcuts]{glossaries} %Glossaries/acronyms
